'use client';
import { SCHOOL_NAME, SCHOOL_MOTTO, SOCIAL_LINKS } from '../constants';

export default function Footer() {
  return (
    <footer className="bg-[#025464] text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* School Info */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold">{SCHOOL_NAME}</h3>
            <p className="text-gray-300">{SCHOOL_MOTTO}</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>Email: info@sankofaacademy.edu</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Join our community for updates</p>
            <form className="flex gap-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="bg-[#014351] text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E57C23] flex-grow"
              />
              <button
                type="submit"
                className="bg-[#E57C23] text-white px-4 py-2 rounded-md hover:bg-[#E8AA42] transition-colors"
              >
                Subscribe
              </button>
            </form>
